...
class UtilityCategoryController extends Controller
{
    ...
    /**
     * For Deactive Utility categories
     * @param Request $request
     * @param $id
     * @return \Illuminate\Http\Response
     */
    ...
    public function deActive(Request $request, $id)
    {
        try{
            ...
            return $this->sendResponse($category,'Utility categories active successfully');
        }
        catch (\Exception $exception){
            return $this->sendError('Utility categories active error', ['error' => $exception->getMessage()]);
        }
    }

    /**
     * For Active Utility categories
     * @param Request $request
     * @param $id
     * @return \Illuminate\Http\Response
     */
    ...
    public function active(Request $request, $id)
    {
        try{
            ...
            return $this->sendResponse($category,'Utility categories deactive successfully');
        }
        catch (\Exception $exception){
            return $this->sendError('Utility categories deactive error', ['error' => $exception->getMessage()]);
        }
    }
}
